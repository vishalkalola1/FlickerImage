...
class SearchService: NSObject {
    ...
    func request(_ searchText: String, pageNo: Int, completion: @escaping (Result<Photo?>) -> Void) {
    ...
    func processResponse(_ data: Data) -> SearchResult? {
        do {
            let responseModel = try JSONDecoder().decode(SearchResult.self, from: data)
